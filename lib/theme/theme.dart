...
class MaterialTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.light,
      primary: Color(0xff5d222b),
      surfaceTint: Color(0xff8f4951),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xffa05860),
      ...
      tertiaryFixedDim: Color(0xff6d4f27),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff591f28),
      onPrimaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xffffacb4),
      ...
      tertiaryContainer: Color(0xffe4bc8b),
